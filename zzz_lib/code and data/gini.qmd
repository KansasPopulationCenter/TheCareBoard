...
population <- fread("../../01_preliminary-code-and-data/AgeByCounty2020Plus.csv") |>
  clean_names() |> 
  filter(year != 1) |>
  mutate(
    year = case_when(
...
```{r}
employment <- fread("../../01_preliminary-code-and-data/County_Employment_By_IndustryYear.csv") |> 
  clean_names() |> 
  mutate(
