...
lfp <- formal_lfp |>
  ...
  summarise(formal_care_labor_force = sum(formal_care_labor_force),
            ...
            formal_care_labor_force_proportion = mean(formal_care_labor_force_proportion, na.rm = TRUE)) |>
...
lfp <- informal_lfp |>
  ...
  summarise(informal_care_labor_force = sum(informal_care_labor_force),
            ...
            informal_care_labor_force_proportion = mean(informal_care_labor_force_proportion, na.rm = TRUE)) |>
  mutate(geo_level = "national")
...
write.csv(care_lfp, "./data/CSV/care_force.csv", 
          row.names = FALSE)
write_dta(care_lfp, "./data/DTA/care_force.dta")
```
...
write.csv(time, "./data/CSV/care_time.csv", 
          row.names = FALSE)
write_dta(time, "./data/DTA/care_time.dta")
```
...
value <- rbind(formal_value, informal_value)

write.csv(value, "./data/CSV/care_value.csv", 
          row.names = FALSE)
write_dta(value, "./data/DTA/care_value.dta")
```
...
write.csv(sandwich_stats, "./data/CSV/sandwich_stats.csv", 
          row.names = FALSE)
write_dta(sandwich_stats, "./data/DTA/sandwich_stats.dta")
